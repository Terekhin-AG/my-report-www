...
**Размещение IT-проекта в интернете с использованием веб-сервисов GitHub и
GitPages.**
...
5. Настройте параметров доступа к репозиторию на GitHub. Для это кликнете правой
